...
def main() -> None:
    ...
    parser.add_argument("--agents", type=int, default=2, help="Number of agents (default: 4)")
    parser.add_argument("--timesteps", type=int, default=5, help="Number of timesteps (default: 100)")
